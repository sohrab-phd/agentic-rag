...
def create_agent_graph(llm, tools_list):
    ...
    agent_builder.add_node("generate_grounded_answer", partial(generate_grounded_answer, llm=llm))
    ...
    agent_builder.add_edge("generate_grounded_answer", "collect_answer")
